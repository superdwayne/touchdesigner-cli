...
```
tests/test_cli.py::TestCLIVersion::test_version PASSED
tests/test_cli.py::TestProjectCommands::test_project_new PASSED
tests/test_cli.py::TestProjectCommands::test_project_new_json PASSED
tests/test_cli.py::TestProjectCommands::test_project_new_with_output PASSED
...
tests/test_operators.py::TestOperatorRegistry::test_all_families_present PASSED
tests/test_operators.py::TestSuggestOperators::test_audio_suggestions PASSED
...
tests/test_network.py::TestNetworkBuilder::test_build_audio_reactive PASSED
tests/test_network.py::TestNetworkBuilder::test_build_feedback_loop PASSED
...
tests/test_project.py::TestTDProject::test_undo_redo PASSED
tests/test_project.py::TestProjectManager::test_save_and_open PASSED
